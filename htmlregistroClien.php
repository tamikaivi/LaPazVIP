    ...
    <a type="submit" href="htmlHome_sin_inicio.php" style="font-size:40px; color: #ffffff; margin-left: 400px; float: left;"><u>Locales</u></a>
        ...
        <form class="md-form" action="htmlHome_sin_inicio.php">
            ...
            <div style="width : 500px; height : 50px; margin-left:450px">
              <div class="input-group input-group-lg" >
                 <div class="input-group-prepend" >
                    <span style="background-color:#15BBA7; color:#ffffff " class="input-group-text" id="inputGroup-sizing-sm">Ciudad</span>
                 </div>
                <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Ingrese su ciudad">
               </div>
            </div>
            <br>
            <br>
